...
export function MobileLayout({ nav, navColor = "#155266", children }) {
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "'DM Sans','Segoe UI',sans-serif",
      ...
      {/* Backdrop */}
      {open && <div onClick={close} style={{ position: "fixed", inset: 0, zIndex: 9989,
        background: "rgba(0,0,0,.4)", backdropFilter: "blur(2px)" }} />}

      {/* Drawer sidebar */}
      <aside style={{
        position: "fixed", top: 0, left: 0, bottom: 0, zIndex: 9990,
      ...
      <button onClick={() => setOpen(o => !o)} style={{
        position: "fixed", bottom: 20, right: 20, zIndex: 9988,
