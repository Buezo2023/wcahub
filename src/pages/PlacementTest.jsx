...
const QUESTIONS = [
  { id:1, level:"A1", q:"What is your name?",
    opts:["I am have María","My name is María","Name I María","Have name María"], ans:1 },
  { id:2, level:"A1", q:"___ is she? She is my sister.",
    opts:["What","Where","Who","How"], ans:2 },
  { id:3, level:"A1", q:"They ___ students.",
    opts:["is","am","be","are"], ans:3 },
  { id:4, level:"A2", q:"I ___ to the store yesterday.",
    opts:["go","goes","went","going"], ans:2 },
  { id:5, level:"A2", q:"She has lived here ___ five years.",
    opts:["since","during","from","for"], ans:3 },
  { id:6, level:"A2", q:"___ you ever been to Mexico?",
    opts:["Has","Had","Did","Have"], ans:3 },
  { id:7, level:"B1", q:"If I ___ you, I would apologize.",
    opts:["was","am","be","were"], ans:3 },
  { id:8, level:"B1", q:"The report ___ by the team last week.",
    opts:["is written","wrote","writes","was written"], ans:3 },
  { id:9, level:"B1", q:"By the time she arrived, we ___ waiting for two hours.",
    opts:["have been","were","was","had been"], ans:3 },
  { id:10, level:"B2", q:"___ he study harder, he might pass.",
    opts:["Would","Could","Shall","Should"], ans:3 },
  { id:11, level:"B2", q:"The phenomenon, ___ was first observed in 1985, remains poorly understood.",
    opts:["that","what","who","which"], ans:3 },
  { id:12, level:"B2", q:"She insisted that he ___ the documents immediately.",
    opts:["signed","signs","signing","sign"], ans:3 },
];
